...
export default function HeroInfoThree({ name }) {
  return (
    <div className="w-[307px] h-[381px] bg-containerColor absolute hover:ring-2 hover:ring-textColor duration-300 transition-all right-0 top-0 mt-[330px] mr-[372px] flex flex-col items-center rounded-sm shadow-sm shadow-black">
