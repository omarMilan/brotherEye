...
export default function HeroInfoTwo({ name }) {
  return (
    <div className="w-[307px] h-[213px] bg-containerColor overflow-y-auto hover:ring-2 hover:ring-textColor duration-300 transition-all absolute right-0 top-0 mt-24 mr-[372px] flex items-center rounded-sm shadow-sm shadow-black">
